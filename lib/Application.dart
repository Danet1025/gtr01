  ...
  search_products.clear();
   if (controller_search.text.isEmpty){
      ...
      search_products = products.where((p) {
        return p["bar_code"].toString().toLowerCase().contains(controller_search.text);
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            showDialog(
                              context: context,
                              builder: (context){
                                return AlertDialog(title: Text("Edit bar_code"),
                                  ...
                                  actions: [
                                    OutlinedButton(onPressed: () async {
                                      ...
                                      await db
                                        ...
                                        .doc(id)
                                        .update({
                                          "bar_code": controller_bar_code.text,
                                        });
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            showDialog(
                              context: context,
                              builder: (context){
                                return AlertDialog(title: Text("Edit name"),
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            ...
                            showDialog(
                              context: context,
                              builder: (context){
                                return AlertDialog(title: Text("Edit country"),
                                  ...
                                  actions: [
                                    OutlinedButton(onPressed: () async {
                                      ...
                                      await db
                                        ...
                                        .doc(id)
                                        .update({
                                          "country": controller_country.text,
                                        });
